---
title: IBybitSocketClientSpotStreamsV2
has_children: false
parent: IBybitClientSpotApi\v2
grand_parent: Rest API documentation
---
*[generated documentation]*  
`BybitClient > SpotApi\v2 > SpotStreamsV2`  
*Bybit spot streams*
...
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToAccountUpdatesAsync(/* parameters */);  
```  
...
```csharp  
var client = new BybitSocketClient();  
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToBookPriceUpdatesAsync(/* parameters */);  
```  
...
```csharp  
var client = new BybitSocketClient();  
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToKlineUpdatesAsync(/* parameters */);  
```  
...
```csharp  
var client = new BybitSocketClient();  
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToOrderBookUpdatesAsync(/* parameters */);  
```  
...
```csharp  
var client = new BybitSocketClient();  
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToTickerUpdatesAsync(/* parameters */);  
```  
...
```csharp  
var client = new BybitSocketClient();  
var result = await client.SpotApi\v2.SpotStreamsV2.SubscribeToTradeUpdatesAsync(/* parameters */);  
```  

...
namespace Bybit.Net.SymbolOrderBooks
{
    ...
    public class BybitInversePerpetualSymbolOrderBook : SymbolOrderBook
    {
        ...
        public BybitInversePerpetualSymbolOrderBook(string symbol, BybitSymbolOrderBookOptions? options = null) : base("Bybit", symbol, options ?? new BybitSymbolOrderBookOptions())
        {

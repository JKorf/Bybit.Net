...
{
    /// <inheritdoc cref="IBybitSocketClientLinearStreams" />
    public class BybitSocketClientLinearStreams : BybitSocketClientBaseStreams, IBybitSocketClientLinearStreams
    {
        internal BybitSocketClientLinearStreams(Log log, BybitSocketClientOptions options)
            : base(log, options, "/linear")
        {

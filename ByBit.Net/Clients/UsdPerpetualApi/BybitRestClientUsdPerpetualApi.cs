...
{
    /// <inheritdoc cref="IBybitRestClientUsdPerpetualApi" />
    public class BybitRestClientUsdPerpetualApi : RestApiClient, IBybitRestClientUsdPerpetualApi
    {
        internal static TimeSyncState _timeSyncState = new TimeSyncState("USD Perpetual Api");
        ...
        /// <inheritdoc />
        public IBybitRestClientUsdPerpetualApiAccount Account { get; }
        /// <inheritdoc />
        public IBybitRestClientUsdPerpetualApiExchangeData ExchangeData { get; }
        /// <inheritdoc />
        public IBybitRestClientUsdPerpetualApiTrading Trading { get; }

        #region ctor
        internal BybitRestClientUsdPerpetualApi(ILogger logger, HttpClient? httpClient, BybitRestOptions options) : 
            base(logger, httpClient, options.Environment.RestBaseAddress, options, options.UsdPerpetualOptions)
        {
            ...
            Account = new BybitRestClientUsdPerpetualApiAccount(this);
            ExchangeData = new BybitRestClientUsdPerpetualApiExchangeData(this);
            Trading = new BybitRestClientUsdPerpetualApiTrading(this);

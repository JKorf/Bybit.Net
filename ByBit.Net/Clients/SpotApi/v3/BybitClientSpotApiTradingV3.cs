...
namespace Bybit.Net.Clients.SpotApi.v3
{
    ...
    public class BybitClientSpotApiTradingV3 : IBybitClientSpotApiTradingV3
    {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitSpotOrderWrapper>> GetOrdersAsync(string? symbol = null, long? orderId = null, int? limit = null, int? orderCategory = 0, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            parameters.AddOptionalParameter("orderId", orderId);
            parameters.AddOptionalParameter("symbol", symbol);

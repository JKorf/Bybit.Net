...
{
    /// <inheritdoc cref="IBybitRestClientSpotApiV1" />
    public class BybitRestClientSpotApiV1 : BybitRestClientBaseSpotApi, IBybitRestClientSpotApiV1
    {
        /// <inheritdoc />
        public IBybitRestClientSpotApiAccountV1 Account { get; }
        /// <inheritdoc />
        public IBybitRestClientSpotApiExchangeDataV1 ExchangeData { get; }
        /// <inheritdoc />
        public IBybitRestClientSpotApiTradingV1 Trading { get; }
        #region ctor
        internal BybitRestClientSpotApiV1(ILogger log, HttpClient? httpClient, BybitRestOptions options)
            : base(log, httpClient, options.Environment.RestBaseAddress, options, options.SpotOptions)
        {
            ...
            Account = new BybitRestClientSpotApiAccountV1(this);
            ExchangeData = new BybitRestClientSpotApiExchangeDataV1(this);
            Trading = new BybitRestClientSpotApiTradingV1(this);
        }
        #endregion

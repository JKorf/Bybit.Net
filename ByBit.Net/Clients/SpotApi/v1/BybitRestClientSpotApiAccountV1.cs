...
{
    /// <inheritdoc />
    public class BybitRestClientSpotApiAccountV1 : IBybitRestClientSpotApiAccountV1
    {
        private BybitRestClientBaseSpotApi _baseClient;

        internal BybitRestClientSpotApiAccountV1(BybitRestClientBaseSpotApi baseClient)
        {

...
{
    /// <inheritdoc />
    public class BybitRestClientSpotApiExchangeDataV1 : IBybitRestClientSpotApiExchangeDataV1
    {
        private BybitRestClientBaseSpotApi _baseClient;

        internal BybitRestClientSpotApiExchangeDataV1(BybitRestClientBaseSpotApi baseClient)
        {

...
namespace ByBit.Net.Clients.Rest.InversePerpetual
{
    ...
    //: IBybitInversePerpetualClientAccount
    {
        ...
        public async Task<WebCallResult<BybitPosition>> GetPositionAsync(string symbol, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestAsync<BybitPosition>(_baseClient.GetUrl("private/position/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult<IEnumerable<BybitPosition>>> GetPositionsAsync(long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<IEnumerable<BybitPositionData>>(_baseClient.GetUrl("private/position/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
            if (!result)
        ...
        public async Task<WebCallResult<decimal>> ChangeMarginAsync(string symbol, decimal margin, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestAsync<decimal>(_baseClient.GetUrl("private/position/change-position-margin"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult<int>> SetLeverageAsync(string symbol, int leverage, bool? leverageOnly = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestAsync<int>(_baseClient.GetUrl("private/position/leverage/save"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult<BybitPage<IEnumerable<BybitPnlEntry>>>> GetProfitAndLossHistoryAsync(string symbol, DateTime? startTime = null, DateTime? endTime = null, TradeType? type = null, int? page = null, int? pageSize = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<BybitPage<IEnumerable<BybitPnlEntry>>>(_baseClient.GetUrl("private/trade/closed-pnl/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        ...
        public async Task<WebCallResult<BybitTpSlMode>> SetFullPartialPositionModeAsync(string symbol, StopLossTakeProfitMode mode, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestAsync<BybitTpSlMode>(_baseClient.GetUrl("private/tpsl/switch-mode"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult> SetPositionModeAsync(string symbol, bool isIsolated, decimal buyLeverage, decimal sellLeverage, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<object>(_baseClient.GetUrl("private/position/switch-isolated"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);

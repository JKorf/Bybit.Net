...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientUsdFuturesTrading//: IBybitClientInversePerpetualTrading
    {
        private BybitClientUsdFutures _baseClient;

        internal BybitClientUsdFuturesTrading(BybitClientUsdFutures baseClient)
        {

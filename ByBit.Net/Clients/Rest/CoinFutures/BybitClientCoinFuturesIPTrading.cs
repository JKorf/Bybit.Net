...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientCoinFuturesIPTrading//: IBybitClientInversePerpetualTrading
    {
        private BybitClientCoinFutures _baseClient;

        internal BybitClientCoinFuturesIPTrading(BybitClientCoinFutures baseClient)
        {

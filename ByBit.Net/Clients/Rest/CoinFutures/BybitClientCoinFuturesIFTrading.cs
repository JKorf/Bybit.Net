...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientCoinFuturesIFTrading//: IBybitClientInversePerpetualTrading
    {
        private BybitClientCoinFutures _baseClient;

        internal BybitClientCoinFuturesIFTrading(BybitClientCoinFutures baseClient)
        {

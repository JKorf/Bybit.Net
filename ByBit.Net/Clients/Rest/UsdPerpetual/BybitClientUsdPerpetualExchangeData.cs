...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientUsdPerpetualExchangeData : IBybitClientUsdPerpetualExchangeData
    {
        private BybitClientUsdPerpetual _baseClient;

        internal BybitClientUsdPerpetualExchangeData(BybitClientUsdPerpetual baseClient)
        {

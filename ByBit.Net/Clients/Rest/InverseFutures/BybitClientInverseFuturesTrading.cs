...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientInverseFuturesTrading: IBybitClientInverseFuturesTrading//: IBybitClientInversePerpetualTrading
    {
        private BybitClientInverseFutures _baseClient;

        internal BybitClientInverseFuturesTrading(BybitClientInverseFutures baseClient)
        {

...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientInverseFuturesAccount : IBybitClientInverseFuturesAccount
    {
        private BybitClientInverseFutures _baseClient;

        internal BybitClientInverseFuturesAccount(BybitClientInverseFutures baseClient)
        {

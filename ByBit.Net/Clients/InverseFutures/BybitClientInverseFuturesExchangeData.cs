...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public class BybitClientInverseFuturesExchangeData: IBybitClientInverseFuturesExchangeData //: BybitClientFuturesBaseExchangeData
    {
        private BybitClientInverseFutures _baseClient;

        internal BybitClientInverseFuturesExchangeData(BybitClientInverseFutures baseClient)
        {

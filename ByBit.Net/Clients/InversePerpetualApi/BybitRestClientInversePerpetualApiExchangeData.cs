...
{
    /// <inheritdoc />
    public class BybitRestClientInversePerpetualApiExchangeData : IBybitRestClientInversePerpetualApiExchangeData
    {
        private BybitRestClientInversePerpetualApi _baseClient;

        internal BybitRestClientInversePerpetualApiExchangeData(BybitRestClientInversePerpetualApi baseClient)
        {

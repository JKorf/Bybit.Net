...
{
    /// <inheritdoc />
    public class BybitRestClientInversePerpetualApiAccount : IBybitRestClientInversePerpetualApiAccount
    {
        private BybitRestClientInversePerpetualApi _baseClient;

        internal BybitRestClientInversePerpetualApiAccount(BybitRestClientInversePerpetualApi baseClient)
        {

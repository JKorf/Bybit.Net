...
{
    /// <inheritdoc />
    public class BybitRestClientInversePerpetualApiTrading : IBybitRestClientInversePerpetualApiTrading
    {
        private BybitRestClientInversePerpetualApi _baseClient;

        internal BybitRestClientInversePerpetualApiTrading(BybitRestClientInversePerpetualApi baseClient)
        {

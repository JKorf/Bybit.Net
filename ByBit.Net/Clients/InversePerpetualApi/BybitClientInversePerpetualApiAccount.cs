...
namespace Bybit.Net.Clients.InversePerpetualApi
{
    ...
    public class BybitClientInversePerpetualApiAccount : IBybitClientInversePerpetualApiAccount
    {
        ...
        public async Task<WebCallResult<BybitRiskId>> SetRiskLimitAsync(string symbol, long riskId, PositionMode? mode = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestAsync<BybitRiskId>(_baseClient.GetUrl("v2/public/risk-limit/list"), HttpMethod.Post, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        public async Task<WebCallResult<IEnumerable<BybitPosition>>> GetPositionsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<IEnumerable<BybitPositionData>>(_baseClient.GetUrl("v2/private/order/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
            if (!result)

...
{
    /// <inheritdoc />
    public class BybitRestClientInverseFuturesApiTrading : IBybitRestClientInverseFuturesApiTrading
    {
        private BybitRestClientInverseFuturesApi _baseClient;

        internal BybitRestClientInverseFuturesApiTrading(BybitRestClientInverseFuturesApi baseClient)
        {

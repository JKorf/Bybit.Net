...
{
    /// <inheritdoc />
    public class BybitRestClientInverseFuturesApiExchangeData : IBybitRestClientInverseFuturesApiExchangeData
    {
        private BybitRestClientInverseFuturesApi _baseClient;

        internal BybitRestClientInverseFuturesApiExchangeData(BybitRestClientInverseFuturesApi baseClient)
        {

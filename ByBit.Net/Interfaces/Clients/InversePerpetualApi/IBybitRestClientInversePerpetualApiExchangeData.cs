...
namespace Bybit.Net.Interfaces.Clients.InversePerpetualApi
{
    ...
    /// </summary>
    public interface IBybitRestClientInversePerpetualApiExchangeData
    {
        /// <summary>
        /// Get the server time
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitTicker>>> GetTickersAsync(string? symbol = null, CancellationToken ct = default);

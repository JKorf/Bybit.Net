...
namespace Bybit.Net.Clients.Rest.Futures
{
    ...
    /// </summary>
    public interface IBybitClientInversePerpetualApiExchangeData
    {
        /// <summary>
        /// Get the server time
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-servertime</para>
        /// </summary>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-announcement</para>
        /// </summary>
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-querysymbol</para>
        /// </summary>
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-latestsymbolinfo</para>
        /// </summary>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-publictradingrecords</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-orderbook</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        ...
        /// <summary>
        /// Get price klines
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-querykline</para>
        /// </summary>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-queryindexpricekline</para>
        /// </summary>
        /// <param name="symbol">Symbol of the klines</param>
        /// <param name="interval">Interval of the kline data</param>
        /// <param name="from">Start time of the data</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-querypremiumindexkline</para>
        /// </summary>
        /// <param name="symbol">Symbol of the klines</param>
        /// <param name="interval">Interval of the kline data</param>
        /// <param name="from">Start time of the data</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-markpricekline</para>
        /// </summary>
        /// <param name="symbol">Symbol of the klines</param>
        /// <param name="interval">Interval of the kline data</param>
        /// <param name="from">Start time of the data</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-marketaccountratio</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-marketopeninterest</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-marketbigdeal</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        ...
        /// <para>https://bybit-exchange.github.io/docs/inverse/#t-fundingrate</para>
        /// </summary>
        /// <param name="symbol">The symbol</param>
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>

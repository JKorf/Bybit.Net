...
namespace Bybit.Net.Interfaces.Clients.SpotApi.v3
{
    ...
    public interface IBybitClientSpotApiTradingV3
    {
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitSpotOrderWrapper>> GetOrdersAsync(string? symbol = null, long? orderId = null, int? limit = null, int? orderCategory = 0, long? receiveWindow = null, CancellationToken ct = default);
